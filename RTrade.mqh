...
private:
   ...
   int               m_EMUL_TR_CaterpillarNEW(const char Case,const int IterationNum,const STRUCT_FEED_OHLC &Feed[],const int OHLC);
   ...
   //Open Rule WO Indicator                                  
   int               m_EMUL_OpenRuleNEW(const ENUM_EMUL_OpenRule OpenRuleNum,const char Case,const int IterationNum,
                                        const int OHLC,const STRUCT_FEED_OHLC &Feed[]);
...
/*
        ...
        */
            ...
            //1. Check Open Rule 
            int OTR_RESULT=m_EMUL_OpenRuleNEW(m_open_rule_num_emul,Case,i,OHLC,Feed);
...
//| Open Rule WO Indicator                                           |
//+------------------------------------------------------------------+
int RTrade::m_EMUL_OpenRuleNEW(const ENUM_EMUL_OpenRule OpenRuleNum,const char Case,const int IterationNum,
                               const int OHLC,const STRUCT_FEED_OHLC &Feed[])
  {
//TR_RESULT  
   int TR_RES=-1;
   ...
   switch(OpenRuleNum)
     {
      case  0:TR_RES=m_EMUL_TR_CaterpillarNEW(Case,IterationNum,Feed,OHLC);
...
//If Ok
   return(TR_RES);
  }//END OF Open Rule WO Indicator  
//+------------------------------------------------------------------+
//+------------------------------------------------------------------+
//| TR Caterpillar WO Indicator                                      |
//+------------------------------------------------------------------+
int RTrade::m_EMUL_TR_CaterpillarNEW(const char Case,const int IterationNum,const STRUCT_FEED_OHLC &Feed[],const int OHLC)
  {
//Cases: Case0=1,Case1=4,Case2=14
   int i=IterationNum;
